...
shasum -a 256 dash-$VERSION.$MINOR-win32.zip >> dash-$VERSION.$MINOR-win32.zip.DIGESTS.txt
shasum -a 256 dash-$VERSION.$MINOR-win64.zip >> dash-$VERSION.$MINOR-win64.zip.DIGESTS.txt
shasum -a 256 dash-$VERSION.$MINOR-win32-setup.exe >> dash-$VERSION.$MINOR-win32-setup.exe.DIGESTS.txt
shasum -a 256 dash-$VERSION.$MINOR-win64-setup.exe >> dash-$VERSION.$MINOR-win64-setup.exe.DIGESTS.txt
shasum -a 256 dash-$VERSION.$MINOR-linux32.tar.gz >> dash-$VERSION.$MINOR-linux32.tar.gz.DIGESTS.txt
